...
퍼블릭 서브넷에 배치된 EC2 서비스 서버를 배포해서 누구든지 서비스를 제공 받을 수 있게 구성했습니다. 하지만 퍼브릭 서브넷은 보안적으로 문제가 있었고, Bas Host를 도입하면서 서비스 서버를 프라이빗 서브넷으로 이전시켜 서비스 서버로 직접적인 접근이 불가능하도록 구성했습니다. 
